...
def expected_score(player1_id: int, player2_id: int, player3_id: int, player4_id: int):
    ...
    if rc == 200 and results:
        ...
        if len(teams_result) >= 2:
            ...
            # Determine winner
            if isinstance(team1_score, (int, float)) and isinstance(
                team2_score, (int, float)
            ):
        ...
        try:
                    ...
                    if isinstance(team1_score, (int, float)) and isinstance(
                        ...
                        if team1_score > team2_score:
                            ...
                            if team1_avg > team2_avg:
                                print(
                                    f"   💡 Team 1 favored - win by {margin:.1f}+ for max rating gain"
                                )
                            else:
                                print(
                                    f"   💡 Team 1 underdog - any win = big rating boost!"
                                )
                            ...
                            if team2_avg > team1_avg:
                                print(
                                    f"   💡 Team 2 favored - win by {margin:.1f}+ for max rating gain"
                                )
                            else:
                                print(
                                    f"   💡 Team 2 underdog - any win = big rating boost!"
                                )
                        else:
                            print(f"🤝 Predicted: Tie")
                            print(
                                f"   💡 Very competitive - any win = significant rating boost!"
                            )
                else:
                    print("❌ Invalid response format")
            else:
            ...
            if rating_diff < 0.1:
                print(
                    f"📊 Rating-based prediction: Very close match (diff: {rating_diff:.3f})"
                )
